...
public final class ResourceAnnotationProcessor extends AbstractProcessor {
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		...
		if (a != null) {
			...
			try {
				...
				writeNamingFile(className, processingEnv, colors, fonts, null, resources);
	...
	private static void writeNamingFile(String className, ProcessingEnvironment processingEnv, Object[][] colors,
			final Object[][] fonts, String i18nUrl, final Object[][] resources) throws Exception {
		...
		try (PrintWriter out = new PrintWriter(builderFile.openWriter())) {
			...
			out.println(" {");
			out.println();
			out.print("public static final class Colors {");
			if (colors != null) {
				int i = 0;
				...
				out.print("private static final java.awt.Color[] colors = new java.awt.Color[]{");
				i = 0;
				for (final Object[] cs : colors) {
			...
			out.println();
			out.print("public static final class Fonts {");
			if (fonts != null) {
				int i = 0;
				...
				out.print("private static final java.awt.Font[] fonts = new java.awt.Font[]{");
				i = 0;
				for (final Object[] cs : fonts) {
			...
			out.println();
			out.print("public static final class Resources {");
			if (fonts != null) {
				int i = 0;
				...
				out.print("private static final String[] resources = new String[]{");
				i = 0;
				for (final Object[] cs : resources) {
